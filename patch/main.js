atuiKernel_FooterLastedited(2,11,2022);
...
document.getElementById('testRunMusic').addEventListener("click",function(){atuiMediasplayer_AudioplayerMusicChange(['patch/musics/test-audioplayer.mp3','patch/musics/test-audioplayer.png','Uplink','Sinking Ship',undefined,'2022'])});
